                          ...
                          <table class="table table-bordered table-hover text-center" id="tb_prom_cur">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td> <span class="label label-primary" style="text-transform: uppercase;"> {{ $inscription->name .' '. $inscription->firstlastname }}</span></td>

                                <td>
                                  <div>

                                    <a title="Ver consolidado" data-toggle="tooltip" data-placement="top" href="{{ route('inscriptions.show', $inscription->id) }}" target="_blank" class="btn btn-xs btn-info" > 

                                      <i class="fa fa-list-ul" aria-hidden="true"></i>
                                    </a> 
                                    <a data-toggle="tooltip" data-placement="top" href="{{ route('inscriptions.edit', $inscription->id) }}" target="_blank" class="btn btn-xs btn-primary" title="Editar curso">
