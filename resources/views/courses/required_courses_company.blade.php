...
@section('content')
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-users"></i> Consolidado de asistencia que pasaron el curso obligatorio.
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header">
                        <div>
                            @if($companies != [])
                                <a href="{{ route('export_daily_report_required') }}"
                                   class="btn btn-success btn-sm pull-right">
                                    <i class="fa fa-download"></i> Exportar Status Contratas
                                </a>
                                <a href="{{ route('export_status_list_contrata') }}"
