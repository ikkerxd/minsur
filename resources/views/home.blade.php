  ...
  <div class="col-md-12">
    <div class="box box-danger text-center">
      <div class="box-body">
          <div class="jumbotron">
  <div class="container">
     <img src="{{ asset('img/logo_isem.png') }}" class="img-responsive center-block" />
       <hr>
          
         <a href="{{ route('validate-participant') }}" class="btn btn-success">BUSCAR PERSONAL</a>
  </div>
</div>
      ...
      <div class="box-footer clearfix">              
        <p>ENVIAR LA DATA EN EXCEL AL TERMINAR CADA CURSO AL CORREO <a href="mailto:registro@ighgroup.com">registro@ighgroup.com</a></p>
      </div>       
   </div>  
 </div>
</div>
